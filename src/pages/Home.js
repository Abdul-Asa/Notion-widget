...
// import { addLikes, getLikes, removeLikes } from '../utils/firebase.store';
...
function Home() {
  ...
  const [quotes, setQuotes] = useState(displayQuotes[0]);
  ...
  // useEffect(() => {
  //   likes === 5
  //     ? localStorage.setItem('voted', 'max')
      ...
      >
        ...
        <SnapContainer id="slide1">
          ...
          >
            ...
            {(isPhoneSize || isLaptopSize) && (
              <Flex position={'relative'} left={'2%'} justify="center">
                ...
                >
                  ...
                  >
                    {' '}
                    <Heading fontSize={'13px'}>{quotes.content}</Heading>
            ...
            {/* <Button onClick={handleReplay}>Wow</Button> */}
          </Flex>
        </SnapContainer>
          ...
          >
            ...
            >
                  ...
                  <motion.button whileHover={{ scale: 1.09 }} type="submit">
                    ...
                    >
                      ...
                      >
                        ...
                        <Text fontSize={['10px', '10px', '11px']}>
                          If you can, please leave a star on the github
                          repository 😘
                        </Text>
                      </Box>
                      <Flex
              ...
              <Heading textAlign={'center'} fontWeight="medium" fontSize={'sm'}>
                Just click the heart to leave a like 🤗 (or right click to
                unlike 😒)
              </Heading>
              <Stack align={'center'} spacing={1}>
                ...
                <Button
                  ...
                  onClick={
                    bar < 1
                      ? () => {
                          const max = localStorage.getItem('voted');
                          if (max) console.log('All votes count already');
                          setBar(bar + 0.2);
                          setLikes(likes + 1);
                          // addLikes(likes + 1);
